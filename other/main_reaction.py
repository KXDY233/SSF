...
parser.add_argument('--data', type=str,  default='iAF692', help='graph name')
parser.add_argument('--data_split',type=str, default='4',
...
if __name__ == '__main__':
    ...
    tf1 = round(f1,3)
    auc1 = round(auc,3)
    file_out = args.data + '_' + args.data_split + '_' + str(tf1) + '_' + str(auc1) + '.txt'
