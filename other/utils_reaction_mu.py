...
def prepare_data(args):
    ...
    if os.path.exists(data_dir):
        ...
        train_lb = data['train_lb']
        test_lb = data['test_lb']
        val_lb = data['val_lb']
    else:
        ...
        torch.save({'train_data': train_data, 'val_data': val_data, 'test_data': test_data, 'train_lb': train_lb, 'val_lb': val_lb, 'test_lb': test_lb}, data_dir)
